...
class CropperSelection extends _cropper_element__WEBPACK_IMPORTED_MODULE_0__["default"] {
    ...
    $handleAction(event) {
        ...
        const relatedTarget = relatedEvent
            ? (0,_cropper_utils__WEBPACK_IMPORTED_MODULE_1__.getComposedPathTarget)(relatedEvent)
            : null;
    ...
    connectedCallback() {
        ...
        if ($canvas) {
            ...
            if ($selection) {
                ...
                (0,_cropper_utils__WEBPACK_IMPORTED_MODULE_1__.on)($canvas, _cropper_utils__WEBPACK_IMPORTED_MODULE_1__.EVENT_ACTION_START, this.$onCanvasActionStart);
                (0,_cropper_utils__WEBPACK_IMPORTED_MODULE_1__.on)($canvas, _cropper_utils__WEBPACK_IMPORTED_MODULE_1__.EVENT_ACTION_END, this.$onCanvasActionEnd);
                (0,_cropper_utils__WEBPACK_IMPORTED_MODULE_1__.on)($canvas, _cropper_utils__WEBPACK_IMPORTED_MODULE_1__.EVENT_CHANGE, this.$onSelectionChange);
            }
        }
        this.$render();
    }
    disconnectedCallback() {
        ...
        if ($canvas) {
            ...
            if (this.$onSelectionChange) {
                (0,_cropper_utils__WEBPACK_IMPORTED_MODULE_1__.off)($canvas, _cropper_utils__WEBPACK_IMPORTED_MODULE_1__.EVENT_CHANGE, this.$onSelectionChange);
                this.$onSelectionChange = null;
            }
        }
        super.disconnectedCallback();
...
class CropperViewer extends _cropper_element__WEBPACK_IMPORTED_MODULE_0__["default"] {
    ...
    connectedCallback() {
        ...
        let $selection = null;
        if (this.selection) {
            $selection = (_b = (_a = (0,_cropper_utils__WEBPACK_IMPORTED_MODULE_1__.getRootDocument)(this)) === null || _a === void 0 ? void 0 : _a.querySelector(this.selection)) !== null && _b !== void 0 ? _b : null;
        }
        else {
...
/* harmony export */   getComposedPathTarget: () => (/* binding */ getComposedPathTarget),
/* harmony export */   getOffset: () => (/* binding */ getOffset),
/* harmony export */   getRootDocument: () => (/* binding */ getRootDocument),
...
/* harmony export */   getComposedPathTarget: () => (/* reexport safe */ _cropper_utils__WEBPACK_IMPORTED_MODULE_0__.getComposedPathTarget),
/* harmony export */   getOffset: () => (/* reexport safe */ _cropper_utils__WEBPACK_IMPORTED_MODULE_0__.getOffset),
/* harmony export */   getRootDocument: () => (/* reexport safe */ _cropper_utils__WEBPACK_IMPORTED_MODULE_0__.getRootDocument),
    ...
    constructor(element, options) {
        ...
        if (container) {
            if ((0,_cropper_utils__WEBPACK_IMPORTED_MODULE_0__.isString)(container)) {
                container = (_a = (0,_cropper_utils__WEBPACK_IMPORTED_MODULE_0__.getRootDocument)(element)) === null || _a === void 0 ? void 0 : _a.querySelector(container);
            }
...
window.Cropper = cropperjs__WEBPACK_IMPORTED_MODULE_0__["default"];
...
window.imageEditor = function (mediaId, imageUrl) {
  return {
    ...
    initCropper: function initCropper() {
      var _this2 = this;
      var img = this.$refs.cropperImage;
      if (!img) {
      ...
      if (!img.complete) {
        img.onload = function () {
          return _this2.createCropper(img);
        };
      } else {
        this.createCropper(img);
      }
    },
    createCropper: function createCropper(img) {
      var _this3 = this;
      if (this.cropper) {
        this.cropper.destroy();
      }
      this.cropper = new cropperjs__WEBPACK_IMPORTED_MODULE_0__["default"](img, {
        viewMode: 1,
        dragMode: 'crop',
        aspectRatio: NaN,
        autoCropArea: 0.8,
      ...
      return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        ...
        return _regeneratorRuntime().wrap(function (_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              if (!(!_this4.cropper || _this4.loading)) {
                _context.next = 1;
                break;
              }
            ...
            case 1:
              _this4.loading = true;
              _this4.message = '';
              data = _this4.cropper.getData(true);
              _context.prev = 2;
              _context.next = 3;
              return _this4.$wire.cropImage(data.x, data.y, data.width, data.height);
            case 3:
              result = _context.sent;
              _this4.message = result.message;
              _this4.messageType = result.success ? 'success' : 'error';
              if (result.success) {
                // Refresh the image
                _this4.imageUrl = _this4.imageUrl.split('?')[0] + '?t=' + Date.now();
                _this4.$nextTick(function () {
                  _this4.cropper.destroy();
                  setTimeout(function () {
                    return _this4.initCropper();
                  }, 300);
                });
              }
              _context.next = 5;
            ...
            case 4:
              _context.prev = 4;
              _t = _context["catch"](2);
              _this4.message = 'Error: ' + _t.message;
...
window.contextMenuHandler = function () {
  return {
    ...
    itemId: null,
    itemType: null,
    open: function open(event, itemId, itemType) {
      event.preventDefault();
      this.itemId = itemId;
...
/***/ "./resources/assets/scss/media-manager.scss":
/*!**************************************************!*\
  !*** ./resources/assets/scss/media-manager.scss ***!
  \**************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/******/ 		var installedChunks = {
/******/ 			"/public/vendor/polirium/core/media/js/media-manager": 0,
/******/ 			"public/vendor/polirium/core/media/css/media-manager": 0
/******/ 		};
/******/ 		
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkpolirium_media"] = self["webpackChunkpolirium_media"] || [];
...
/******/ 	__webpack_require__.O(undefined, ["public/vendor/polirium/core/media/css/media-manager"], () => (__webpack_require__("./resources/assets/js/media-manager.js")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["public/vendor/polirium/core/media/css/media-manager"], () => (__webpack_require__("./resources/assets/scss/media-manager.scss")))
