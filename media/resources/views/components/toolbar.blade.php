...
<div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
    ...
    <div class="d-flex gap-2 flex-wrap align-items-center">
        ...
        <div class="input-icon" style="width: 180px;">
            ...
            <input type="text" wire:model.live.debounce.300ms="search" class="form-control form-control-sm" placeholder="{{ __('core/media::media.search') }}">
        </div>
        ...
        <div class="btn-group view-mode-toggle" role="group" aria-label="View mode">
            <button type="button" wire:click="setViewMode('grid')" class="btn btn-icon {{ $viewMode === 'grid' ? 'btn-primary' : 'btn-outline-secondary' }}" style="padding: 0.375rem 0.5rem; border-radius: 4px 0 0 4px;" title="{{ __('core/media::media.grid') }}">
            ...
            <button type="button" wire:click="setViewMode('list')" class="btn btn-icon {{ $viewMode === 'list' ? 'btn-primary' : 'btn-outline-secondary' }}" style="padding: 0.375rem 0.5rem; border-radius: 0 4px 4px 0; margin-left: -1px;" title="{{ __('core/media::media.list') }}">
