...
<div class="context-menu"
    ...
    <template x-if="selectedType === 'file'">
        <div>
            ...
            {{-- Copy/Move Group --}}
            <div class="context-menu-item" @click="navigator.clipboard.writeText(document.querySelector(`[data-media-id='${selectedItem}']`)?.dataset.url || ''); contextMenu = false; alert('Đã copy URL!')">
            ...
            {{-- Danger Zone --}}
            <div class="context-menu-item text-danger" @click="if(confirm('Xác nhận xóa file này?')) { $wire.deleteMedia(selectedItem) }; contextMenu = false">
    ...
    <template x-if="selectedType === 'folder'">
        <div>
            ...
            <div class="context-menu-item text-danger" @click="if(confirm('Xác nhận xóa folder?')) { $wire.deleteFolder(selectedItem) }; contextMenu = false">
