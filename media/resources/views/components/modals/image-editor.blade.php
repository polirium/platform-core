        ...
        <div class="modal-dialog modal-xl modal-dialog-centered" @click.stop>
            <div class="modal-content">
                <div class="modal-header py-2">
                    <h5 class="modal-title">{{ __('Chỉnh sửa ảnh') }}</h5>
                        ...
                        <div class="col-md-4">
                            <div class="tools-panel p-3 rounded" style="background: var(--tblr-bg-surface-secondary);">
                                ...
                                <div class="tool-section">
                                    ...
                                    <div class="mb-2">
                                        <label class="form-label small text-muted">Tỉ lệ khung</label>
                                        <div class="btn-group w-100">
                                            <button type="button" class="btn btn-sm btn-outline-secondary" @click="setAspectRatio(0)">Tự do</button>
                                    ...
                                    <div class="d-flex gap-2">
                                        ...
                                        <button type="button" class="btn btn-sm btn-primary flex-fill" @click="applyCrop()" :disabled="loading">
                                            <span x-show="!loading">Áp dụng cắt</span>
                                ...
                                <div class="tool-section">
                                    <div class="tool-label">
                                        ...
                                        {{ __('Thay đổi kích thước') }}
                                    </div>

                                    <div class="row g-2 mb-2">
                                        <div class="col-6">
                                            <input type="number" wire:model="resizeWidth" class="form-control form-control-sm" placeholder="Rộng (px)">
                                        </div>
                                        <div class="col-6">
                                            <input type="number" wire:model="resizeHeight" class="form-control form-control-sm" placeholder="Cao (px)">
                                        </div>
                                    </div>
                                    <button type="button" wire:click="resizeImage" class="btn btn-sm btn-outline-primary w-100">
                                        Resize
                                    </button>
                                </div>
                                ...
                                <div class="tool-section">
                                    ...
                                    <div class="mb-2">
                                        <label class="form-label small text-muted">Xoay</label>
                                        <div class="btn-group w-100">
                                    ...
                                    <div>
                                        <label class="form-label small text-muted">Lật</label>
                                        <div class="btn-group w-100">
                ...
                <div class="modal-footer py-2">
                    <button type="button" wire:click="closeImageEditor" @click="destroy()" class="btn btn-secondary">
                        {{ __('Đóng') }}
                    </button>
                </div>
            </div>
