            ...
            <div class="container-xl">
                ...
                <div class="navbar-nav flex-row order-md-last">
                    ...
                    <div class="nav-item d-none d-md-flex me-3">
                        <a href="{{ route('products.payment') }}" class="btn btn-primary">
                            {!! tabler_icon('shopping-cart', ['class' => 'icon me-1']) !!}
                            {{ trans('core/base::general.sales') }}
                        </a>
                    </div>
                            ...
                            <div class="dropdown-menu dropdown-menu-arrow dropdown-menu-end dropdown-menu-card">
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="card-title">{{ trans('core/base::general.notifications') }}</h3>
                                    </div>
                                    <div class="list-group list-group-flush list-group-hoverable">
                                        ...
                                        @empty
                                            <div class="list-group-item text-center text-muted py-4">
                                                {{ trans('core/base::general.no_new_notifications') }}
                                            </div>
                                        @endforelse
                                    </div>
                                </div>
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                            <a href="{{ route('core.user.profile.view') }}" class="dropdown-item">{{ trans('core/base::general.profile') }}</a>
                            <a href="{{ route('core.user.settings') }}" class="dropdown-item">{{ trans('core/base::general.settings') }}</a>
                            <div class="dropdown-divider"></div>
                            <a href="javascript:void(0);" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="dropdown-item">{{ trans('core/base::general.logout') }}</a>
                        ...
                        <div class="col-12">
                            <ul class="list-inline list-inline-dots mb-0">
                                <li class="list-inline-item">
                                    ...
                                    {{ trans('core/base::general.all_rights_reserved') }}
                                </li>
                            </ul>
                        </div>
                    </div>
