...
const makeTimes_1 = require("@/components/datetime-picker/makeTimes");
exports.default = (options) => ({
    ...
    toggle() {
        ...
        if (!this.popover || this.config.readonly || this.config.disabled)
            return;
    ...
    onSearch(search) {
        ...
        this.search = (0, masker_1.applyMask)(mask, search) ?? '';
