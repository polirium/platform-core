...
class ModalUserComponent extends Component
{
    ...
    public function mount(): void
    {
        ...
        $this->list['statuses'] = [
            'active' => trans('core/base::general.active'),
            'inactive' => trans('core/base::general.inactive'),
        ];
    ...
    public function showCreateModal()
    {
        ...
        $this->isEdit = false;
        $this->user_id = null;
        $this->modalTitle = trans('core/base::general.create_user');
    ...
    public function showEditModal($id = null)
    {
        ...
        $this->isEdit = true;
        $this->user_id = $userId;
        $this->modalTitle = trans('core/base::general.edit_user');
