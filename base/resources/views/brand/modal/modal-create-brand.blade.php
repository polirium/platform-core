                ...
                <div class="brand-modal-hero">
                    ...
                    <div class="brand-modal-text">
                        <h3 class="brand-modal-heading">
                            {{ $isEdit ? trans('core/base::general.edit_brand') : trans('core/base::general.create_brand') }}
                        </h3>
                        <p class="brand-modal-subheading">
                            {{ $isEdit
                                ? trans('core/base::general.edit_brand_description')
                                : trans('core/base::general.create_brand_description')
                            }}
                        </p>
                    </div>
                </div>
                ...
                <div class="brand-modal-form-section">
                    ...
                    <div class="brand-form-field">
                        <label for="brand-note" class="brand-form-label">
                            ...
                            <span class="brand-optional-mark">{{ trans('core/base::general.settings') }}</span>
                        </label>
                        <div class="brand-input-group">
                            <textarea
                                id="brand-note"
