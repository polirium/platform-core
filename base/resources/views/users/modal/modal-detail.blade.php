                        ...
                        <x-ui::card class="h-100">
                            <div class="card-header">
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    <h5 class="card-title mb-0">{{ trans('core/base::general.contact_info') }}</h5>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="info-list">
                        ...
                        <x-ui::card class="h-100">
                            <div class="card-header">
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    <h5 class="card-title mb-0">{{ trans('core/base::general.account_info') }}</h5>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="info-list">
                        ...
                        <x-ui::card>
                            <div class="card-header">
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    <h5 class="card-title mb-0">{{ trans('core/base::general.time_info') }}</h5>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="row g-3">
